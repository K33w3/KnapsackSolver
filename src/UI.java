...
public class UI extends JPanel {
	 ...
	 */
	public UI(final int x, final int y, final int _size) {
		size = _size;
	...
	public void paintComponent(final Graphics g) {
		final Graphics2D localGraphics2D = (Graphics2D) g;
	 ...
	 */
	private Color GetColorOfID(final int i) {
		if (i == 0) {
			return Color.BLUE;
		} else if (i == 1) {
			return Color.ORANGE;
